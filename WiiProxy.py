...
class MultiWii(object):
    ...
    ARM_DELAY   = 0.5
    #WRITE_DELAY = 0.02  #F7
    WRITE_DELAY = 0.03  #F4	#set serial_update_rate_hz=default
    #WRITE_DELAY = 0.02  #F4	#cleanflight
    #WRITE_DELAY = 0.005  #F4	#set serial_update_rate_hz=2000
    ...
    #"channels"  : ("roll", "pitch", "throttle", "yaw"),   #original not working
    #"channels"  : ("roll", "pitch", "yaw", "throttle", "aux1", "aux2", "aux3", "aux4"),  #cleanflight
    OP_DICT_DATA = {
    ...
    def get_arming(self):
        data = self._write_read(MultiWii.ARMING, 3, "8H")
