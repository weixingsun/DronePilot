...
def control():
    ...
    print ("control() -- udp check passed")
    try:
        if logging:
        ...
        #print("run to line #80")
        while True:
            print ("control() -- while loop")
            ...
            print("run to line #107")
            # Update Attitude 
            vehicle.getData(MultiWii.ATTITUDE)

            print("run to line #111")
        ...
        print ("Error in control thread: ",error)
